            ...
            <div className="floors">
                {floors.map((floor) => (
                    <div className="floor">
                        ...
                        <div className="close-btn" onClick={() => removeFloor(floor.floor)}></div>
                    </div>
                ))}
                {floors.length === 0 && <div className="text-center">Přidej více pater!</div>}
                <div className="text-center">
                    <div className="btn success" onClick={() => addPlanFloorRef.current.open()}>

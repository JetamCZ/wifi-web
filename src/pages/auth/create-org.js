...
const CreateOrg = () => {
    ...
    return (
        <div className="page-createOrg">
            <h2><T id="page.auth.createNewOrg.title"/></h2>
            ...
            <p>
                Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Duis pulvinar. Cras pede libero, dapibus nec, pretium sit amet, tempor quis.
            </p>

            <div className="text-right">
                <Link to="/auth"><a className="btn"><T id="page.auth.createNewOrg.backLogin"/></a></Link>
                <span className="btn success" onClick={register}><T id="page.auth.createNewOrg.createNewOrg"/></span>
            </div>
        </div>
    )
}

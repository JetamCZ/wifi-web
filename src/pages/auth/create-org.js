    ...
    return (
        <div className="page-createOrg">
            ...
            <label className="form-control">
                ...
                <QRcodeInput placeholder="Zadejte registrační klíč" onChange={(e) => setData({ ...data, regKey: e })} />
            </label>

            <p>
                K registraci je zapotřebí registrační klíč. (Pokud potřebuje vytvořit registrační klíč kontaktujete nás
                na emailu: <b>info@puhony.eu</b>)
            </p>

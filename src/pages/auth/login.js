...
const LoginPage = () => {
    ...
    return (
        <div className="page-login">
            <h2><T id="page.auth.login.title"/></h2>
            ...
            <div className="text-right">
                <Link to="/auth/create-org"><a className="btn"><T id="page.auth.login.createOrg"/></a></Link>
                <span onClick={login} className="btn success"><T id="page.auth.login.login"/></span>
            </div>
        </div>
    )
}

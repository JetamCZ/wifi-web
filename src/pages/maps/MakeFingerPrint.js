...
const MakeFingerPrint = (props) => {
    ...
    const updateFingerPrintData = () => {
        AxiosInstance.get("/localization/" + id + "/fingerprint/" + point.mac).then((res) => {
    ...
    const send = () => {
        ...
        AxiosInstance.post("/localization/" + id + "/fingerprint", dataSend).then((res) => {
            props.afterSave()
        })
    }
                ...
                <>
                    ...
                    {progressStates.GETTING_DATA === progress && (
                        <>
                            ...
                            <p>
                                Toto může chvíli trvat, je zapotřebí mít signál minimálně od 3 majáků. (pokud lokalizace
                                nemá přiřazené 3 majáky tak je zapotřebí mít signál ke všem přiřazeným majkákům)
                            </p>
                            ...
                            <div className="text-right">
                                {fingerPrintData.length >= 2 || fingerPrintData.length === data.beacons.length ? (

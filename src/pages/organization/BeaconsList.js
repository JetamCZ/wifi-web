        ...
        <>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {beacon.lastSeenDate
                                            ...
                                            : Translations.getId("page.pageOrganization.beacons.neverSeen")}
                                    </td>
                                    <td>{getStatus(beacon)}</td>
                                    <td className="text-right">
                                        <div className="btn sm" onClick={() => openView(beacon._id)}>
                                            zobrazit maják
                                        </div>
                                    </td>
                                </tr>
            ...
            <Modal ref={modal}>
                ...
                <label className="form-control">
                    ...
                    <QRcodeInput placeholder="Zadej device key" onChange={(code) => setFormValue("deviceKey", code)} />
                </label>

...
const MapPlayground = () => {
    ...
    const data = [
        { x: 736, y: 48, distance: 50 },
        { x: 896, y: 464, distance: 80 },
        { x: 400, y: 808, distance: 94 }
    ]
    ...
    return (
        <div>
            ...
            >
                ...
                {resPoint && <Marker mapRef={mapRef} pos={[...resPoint, 0]} icon={deviceIcon} />}
            </Map>
        </div>
    )
}

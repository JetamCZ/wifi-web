...
const OldSettings = () => {
    ...
    return (
        <div className="page-settings w-page-800">
            <h2 className="">
                <Text id="page-settings.language">Language</Text>
            </h2>
            <div className="form-2-cols">
                <label className="input-frame">
                    <div className="title">
                        <Text id={"page-settings.language.lang"}>Language</Text>
                    </div>
                    <select defaultValue={LangContext.lang} onChange={(e) => modifyValue("lang", e.target.value)}>
                ...
                <label className="input-frame">
                    <div className="title">
                        <Text id={"page-settings.language.unknown-translations"}>Unknown translations</Text>
                    </div>
                    <select
                        defaultValue={LangContext.showUnknownTranslation}
                        onChange={(e) => modifyValue("showDefault", e.target.value)}
                    >
                        <option value={false}>ID</option>
                        <option value={true}>Default text</option>
                    </select>
                </label>
            </div>

            <h2 className="">
                <Text id="page-settings.api">API</Text>
            </h2>
            ...
            */}
            ...
            <div className="text-right">
                <span className="btn btn-primary" onClick={save}>
                    Uložit
                </span>
            </div>
        </div>

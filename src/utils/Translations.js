class Translations {
    constructor() {
        this.lang = {
            ...
            'page.pageOrganization.members.modal.info': 'Pro pozvání dalšího člena organizace je zapotřebí vyvořit zvací odkaz, který je platný pouze 7 dní!',
            ...
            'page.pageOrganization.beacons.addModal.desc': 'Maják je fyzické zařízení, které složí k zachycení mobilních zařízení v jeho okolí.',
            ...
            'page.auth.login.error.tooManyRequests': 'Zaslali jste příliš mnoho požadavků na server. Zkuste to později.',

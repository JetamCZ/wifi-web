class Translations {
  constructor() {
    this.lang = {
      ...
      "page.pageOrganization.members.modal.title":
        "Přidání dalšího člena (Vygenerování zvacího kódu)",
      ...
      "page.pageOrganization.members.modal.newToken.clickme":
        "Klikni pro vygenerování zvacího odkazu",
      "page.pageOrganization.members.modal.newToken.getting":
        "Získávám odkaz... počkej",
      "page.pageOrganization.members.modal.newToken.done":
        "Tento odkaz zašli novému členovi!",
      "page.pageOrganization.members.modal.newToken.error":
        "Nastala chyba (zkus to později)",
      ...
      "page.page404.errorDesc":
        "Vámi hledaná stránka neexistuje. Prosím zkontrolujte zadanou URL adresu.",
      ...
      "page.auth.createNewOrg.input.name.placeholder":
      ...
      "page.auth.createNewOrg.error.pathNameError":
        "Název organizace musí mít nejméně 3 znaky",
      ...
      "page.auth.login.error.wrongCredentials":
        "Zadali jste špatné uživatelské jméno, nebo heslo.",
      ...
      "page.auth.register.input.passwordAgain.placeholder":
        "Zedejte znovu heslo",
      "page.auth.register.register": "Registrace",
      "page.auth.register.error.codeValidation":
        "Váš kód sloužící k registraci již není platný!",
      ...
      "page.auth.register.error.email":
        "Vámi zadaný email je ve špatném formátu",

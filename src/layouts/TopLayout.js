                            ...
                            <div className="item user">
                                ...
                                <div className="info">
                                    ...
                                    <div className="nav-user">
                                        <Link to="/settings"><div className="nav-user-item"><T id="component.nav.settings"/></div></Link>
                                        <div className="nav-user-item" onClick={logout}><T id="component.nav.logout"/></div>
                                    </div>
                                </div>
                            </div>
                        }
